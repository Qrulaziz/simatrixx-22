...
class IndikatorUI extends StatelessWidget {
  const IndikatorUI({Key? key}) : super(key: key);
    ...
    return Column(
      children: [
          ...
          children: [
            ...
            const Positioned(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: AssetImage("assets/indikatorm.png"),
                )),
          ],
        ),
        const SizedBox(
        ...
        const ListTile(
          ...
          subtitle: Center(
              child: Text(
            "Indikator materi dalam media ini meliputi: ",
        ...
        Padding(
          ...
          child: Table(
            ...
            children: [
              ...
              buildRow([
                '3.3.7',
                'Menentukan perkalian skalar dengan matriks',
              ]),
              buildRow([
                '3.3.8',
                'Menentukan perkalian matriks dengan matriks',
              ]),
            ],
          ),
        ),
